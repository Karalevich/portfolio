...
export const Banner: BannerComponent = () => {
  ...
  return (
    <article className={styles.banner}>
      ...
      <main className={styles.message}>I have 3 years of experience in Software engineering and creating distinctive
        user
        interfaces for advanced digital companies.
      </main>
      <Button className={styles.button} variant="contained" onClick={handleRedirect}
