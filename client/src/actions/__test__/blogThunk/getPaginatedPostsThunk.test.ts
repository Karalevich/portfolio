...
import { getPaginatedPostsThunk } from '../../blogAction'
import { SET_FETCHING_PAGINATED_POSTS, ADD_POSTS } from '../../../reducers/blog/blogReducer'
...
describe('getPaginatedPostsThunk', () => {
  afterEach(() => {
    axiosMock.reset()
  })
  ...
  test('dispatches the correct actions when posts received', async () => {
    ...
    await store.dispatch(getPaginatedPostsThunk(searchQuery, sortQuery, page) as unknown as AnyAction)
